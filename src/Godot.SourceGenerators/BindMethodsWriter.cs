...
internal static class BindMethodsWriter
{
    public static void Write(IndentedStringBuilder sb, GodotClassSpec spec)
    {
        ...
        sb.AppendUnindentedLine("#pragma warning disable CS0108 // Method might already be defined higher in the hierarchy, that's not an issue.");
        sb.AppendLine("internal static void BindMethods(global::Godot.Bridge.ClassRegistrationContext context)");
        sb.AppendUnindentedLine("#pragma warning restore CS0108 // Method might already be defined higher in the hierarchy, that's not an issue.");
        sb.OpenBlock();
